...
function s=NewtonIterate_low(xv,zeta_CIR,sigma_ini,lambda,Delta,q_CIR,TOL,eps)    % xv denotes initial value. We can change zeta_CIR and Delta by other parameters.
